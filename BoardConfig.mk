...
# Kernel
 BOARD_KERNEL_CMDLINE := console=ttyMSM0,115200,n8 androidboot.console=ttyMSM0 androidboot.hardware=qcom androidboot.configfs=true androidboot.usbcontroller=a800000.dwc3 earlycon=msm_serial_dm,0xc170000 msm_rtb.filter=0x37 ehci-hcd.park=3 sched_enable_hmp=1 sched_enable_power_aware=1 lpm_levels.sleep_disabled=1 service_locator.enable=1 swiotlb=1 lpm_levels.sleep_disabled=1 service_locator.enable=1 swiotlb=1 user_debug=31 androidboot.selinux=permissive
